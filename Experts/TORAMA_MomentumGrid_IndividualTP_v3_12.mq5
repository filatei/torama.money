//+------------------------------------------------------------------+
//|                  TORAMA_MomentumGrid_IndividualTP_v3.12.mq5      |
//|                                          TORAMA CAPITAL           |
//+------------------------------------------------------------------+
...
#property description "✓ Individual TP >100% Allowed | ✓ Max Levels Enforced"
...
int OnInit()
{
   ...
   if(InpEnableIndividualTP && InpTPOffsetPercent <= 0)
      return INIT_PARAMETERS_INCORRECT;
   ...
   PrintFormat("╔════════════════════════════════════════════════════════════════╗");
   PrintFormat("║  TORAMA Grid v3.12 COMPLETE - Magic: %I64d", magicNumber);
   ...
   PrintFormat("║  ✓ Max Grid Levels: %s | Individual TP: %.1f%% (no limit)", 
               InpMaxGridLevels > 0 ? IntegerToString(InpMaxGridLevels) : "UNLIMITED",
               InpTPOffsetPercent);
...
void CreatePanel()
{
   ...
   CreateTxt("Title", x + 28, y + 8, "🔶 TORAMA GRID v3.12", clrWhite, 11, "Arial Black");

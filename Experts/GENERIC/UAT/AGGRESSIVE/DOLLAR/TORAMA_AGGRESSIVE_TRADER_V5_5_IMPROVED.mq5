//+------------------------------------------------------------------+
//|                    TORAMA Aggressive Trader EA v5.4              |
//|                                           TORAMA CAPITAL          |
...
#property description "V5.5: Magic number derived from Chart ID (persistent across parameter changes)"

#define EA_VERSION "5.5"
...
void CreatePanel()
{
   ...
   ObjectSetInteger(0, panelPrefix + "Background", OBJPROP_YSIZE, EnableATRSwitch ? 420 : 380);  // Dynamic height

//+------------------------------------------------------------------+
//|                    TORAMA Aggressive Trader UNIFIED v6.1         |
//|                                           TORAMA CAPITAL          |
...
#property description "Unified BUY/SELL Grid - LOT-BASED Saturation - 6X TP Multiplier"
#property description "Trades both BUY and SELL on single chart"
#property description "6X TP when opposite LOT exposure >= 80% (not position count)"
#property description "Next Buy/Sell levels shown on panel - Safer risk management"

#define EA_VERSION "6.10"

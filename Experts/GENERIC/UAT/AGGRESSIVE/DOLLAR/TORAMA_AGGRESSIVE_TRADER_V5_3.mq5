...
void CreatePanel()
{
   ...
   int y = 30;
   int width = 300;
   int lineHeight = 18;  // Reduced from 20
   ...
   ObjectSetInteger(0, panelPrefix + "Background", OBJPROP_YSIZE, 310);  // Reduced from 410
   ...
   CreateLabel(panelPrefix + "Title", x + 10, yPos, "AGGRESSIVE TRADER", clrGold, 9, "Arial Black");
   CreateLabel(panelPrefix + "Status", x + width - 70, yPos, "✅ ACTIVE", clrLimeGreen, 8, "Arial Bold");
   yPos += 22;
   
   // Buttons - Single row
   CreateButton(panelPrefix + "CloseBtn", x + 10, yPos, 60, 22, "CLOSE", clrRed, clrWhite);
   CreateButton(panelPrefix + "PauseBtn", x + 75, yPos, 60, 22, "PAUSE", clrOrange, clrWhite);
   CreateButton(panelPrefix + "TPBtn", x + 140, yPos, 50, 22, "TP", clrGreen, clrWhite);
   CreateButton(panelPrefix + "SwitchBtn", x + 195, yPos, 50, 22, "MODE", clrDodgerBlue, clrWhite);
   yPos += 28;
   
   // Mode + Price on same line
   color dirColor = (CurrentDirection == BUYONLY) ? clrDodgerBlue : clrOrangeRed;
   CreateLabel(panelPrefix + "DirectionLabel", x + 10, yPos, "Mode:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "Direction", x + 55, yPos, CurrentDirection == BUYONLY ? "BUY" : "SELL", dirColor, 9, "Arial Black");
   CreateLabel(panelPrefix + "PriceLabel", x + 130, yPos, "Price:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "Price", x + 175, yPos, "$0", clrWhite, 8, "Arial Bold");
   yPos += lineHeight;
   
   // Grid + Spread on same line
   CreateLabel(panelPrefix + "GridLabel", x + 10, yPos, "Grid:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "GridSpacing", x + 55, yPos, "0%", clrWhite, 8, "Arial Bold");
   CreateLabel(panelPrefix + "SpreadLabel", x + 130, yPos, "Spread:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "Spread", x + 185, yPos, "0", clrWhite, 8, "Arial Bold");
   yPos += lineHeight;
   
   // ATR reversal prices (if enabled)
   if(EnableATRSwitch)
   {
      // ATR + Day Open on same line
      CreateLabel(panelPrefix + "ATRLabel", x + 10, yPos, "ATR:", clrGold, 8, "Arial Bold");
      CreateLabel(panelPrefix + "ATRValue", x + 55, yPos, "$0", clrAqua, 8, "Arial Bold");
      CreateLabel(panelPrefix + "DayOpenLabel", x + 130, yPos, "Open:", clrGold, 8, "Arial Bold");
      CreateLabel(panelPrefix + "DayOpenValue", x + 175, yPos, "$0", clrAqua, 8, "Arial Bold");
      yPos += lineHeight;
      
      // REVERSAL PRICES - New feature
      CreateLabel(panelPrefix + "ReversalLabel", x + 10, yPos, "↑SELL @:", clrOrangeRed, 8, "Arial Black");
      CreateLabel(panelPrefix + "ReversalSell", x + 65, yPos, "$0", clrOrangeRed, 8, "Arial Bold");
      CreateLabel(panelPrefix + "ReversalLabel2", x + 130, yPos, "↓BUY @:", clrDodgerBlue, 8, "Arial Black");
      CreateLabel(panelPrefix + "ReversalBuy", x + 185, yPos, "$0", clrDodgerBlue, 8, "Arial Bold");
      yPos += lineHeight;
   }
   
   // Reference
   CreateLabel(panelPrefix + "RefLabel", x + 10, yPos, "Reference:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "RefPrice", x + 80, yPos, "$0", clrWhite, 8, "Arial Bold");
   yPos += lineHeight + 3;
   
   // EA Positions + Account-wide counts on same line
   CreateLabel(panelPrefix + "PosLabel", x + 10, yPos, "⚡EA:", clrGold, 8, "Arial Black");
   CreateLabel(panelPrefix + "Positions", x + 50, yPos, "0/0", clrWhite, 8, "Arial Black");
   CreateLabel(panelPrefix + "AccLabel", x + 130, yPos, "Acc:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "AccCounts", x + 165, yPos, "B:0 S:0", clrWhite, 8, "Arial Bold");
   yPos += lineHeight + 3;
   
   // P/L + Equity on same line
   CreateLabel(panelPrefix + "PnLLabel", x + 10, yPos, "P/L:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "PnL", x + 50, yPos, "$0", clrWhite, 9, "Arial Black");
   CreateLabel(panelPrefix + "EquityLabel", x + 130, yPos, "Equity:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "Equity", x + 180, yPos, "$0", clrWhite, 8, "Arial Bold");
   yPos += lineHeight;
   
   // Drawdown + Daily on same line
   CreateLabel(panelPrefix + "DDLabel", x + 10, yPos, "DD:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "DD", x + 50, yPos, "0%", clrWhite, 8, "Arial Bold");
   CreateLabel(panelPrefix + "DailyLabel", x + 130, yPos, "Daily:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "DailyProfit", x + 180, yPos, "$0", clrWhite, 8, "Arial Bold");
   yPos += lineHeight;
   
   // Mode switches
   CreateLabel(panelPrefix + "SwitchCountLabel", x + 10, yPos, "Switches:", clrGold, 8, "Arial Bold");
   CreateLabel(panelPrefix + "SwitchCount", x + 80, yPos, "0", clrCyan, 8, "Arial Bold");
   yPos += lineHeight + 8;
   ...
   ObjectSetInteger(0, panelPrefix + "Brand", OBJPROP_FONTSIZE, 9);

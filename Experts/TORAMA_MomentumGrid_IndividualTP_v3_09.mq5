//+------------------------------------------------------------------+
//|                  TORAMA_MomentumGrid_IndividualTP_v3.09.mq5      |
//|                                          TORAMA CAPITAL           |
//+------------------------------------------------------------------+
#property copyright "TORAMA CAPITAL"
#property link      "https://toramacapital.com"
#property version   "3.09"
#property description "Momentum Grid EA - Enhanced UI + Force Market Orders"
#property description "✓ Improved Panel | ✓ Comma Separators | ✓ Individual TP"
...
int OnInit()
{
   ...
   PrintFormat("╔════════════════════════════════════════════════════════════════╗");
   PrintFormat("║  TORAMA Grid v3.09 COMPLETE - Magic: %I64d", magicNumber);
   PrintFormat("║  ✓ Enhanced Panel | ✓ Individual TP: %s | ✓ Force Market: %s", 
...
void CreatePanel()
{
   ...
   CreateTxt("Title", x + 28, y + 8, "🔶 TORAMA GRID v3.09", clrWhite, 11, "Arial Black");

...
#property description "Momentum Grid EA - Individual TP at Next Grid Level"
#property description "✓ Per-Position TP | ✓ Settings-Change Safe | ✓ Daily Profit Target"
...
int OnInit()
{
   ...
   PrintFormat("╔════════════════════════════════════════════════════════════════╗");
   PrintFormat("║  TORAMA Grid v3.07 COMPLETE - Magic: %I64d", magicNumber);
   PrintFormat("║  ✓ Individual TP: %s | ✓ Daily Profit Target | ✓ Debug P/L", 
...
void CreatePanel()
{
   ...
   CreateTxt("Title", x + 28, y + 8, "🔶 TORAMA GRID v3.07", clrWhite, 11, "Arial Black");

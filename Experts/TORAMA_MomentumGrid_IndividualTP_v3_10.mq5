//+------------------------------------------------------------------+
//|                  TORAMA_MomentumGrid_IndividualTP_v3.10.mq5      |
//|                                          TORAMA CAPITAL           |
//+------------------------------------------------------------------+
#property copyright "TORAMA CAPITAL"
#property link      "https://toramacapital.com"
#property version   "3.10"
#property description "Momentum Grid EA - True Sacrosanct Reference"
#property description "✓ Reference Reset ONLY via 'Reset Reference' Button"
...
input bool   InpAutoResetGrid = true;             // Auto-Reset Grid (Global TP/Close All)
...
int OnInit()
{
   ...
   PrintFormat("╔════════════════════════════════════════════════════════════════╗");
   PrintFormat("║  TORAMA Grid v3.10 COMPLETE - Magic: %I64d", magicNumber);
   PrintFormat("║  ✓ Sacrosanct Reference | ✓ Auto-Reset: %s | ✓ Individual TP: %s", 
               InpAutoResetGrid ? "ON" : "OFF",
...
void CreatePanel()
{
   ...
   CreateTxt("Title", x + 28, y + 8, "🔶 TORAMA GRID v3.10", clrWhite, 11, "Arial Black");
   ...
   if(InpEnableReversal)
   {
      ...
      CreateTxt("Rev", x1 + 40, y, StringFormat("Thr:%d|B:%d|S:%d", InpReversalLevels, peakBuyLevelsActivated, peakSellLevelsActivated), 
   ...
   // Row 13: Daily Profit (if enabled)
   if(InpDailyProfitTargetPercent > 0)
   {

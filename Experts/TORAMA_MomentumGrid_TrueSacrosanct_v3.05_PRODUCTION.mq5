//+------------------------------------------------------------------+
//|                  TORAMA_MomentumGrid_TrueSacrosanct_v3.05.mq5    |
//|                                          TORAMA CAPITAL           |
//+------------------------------------------------------------------+
...
#property description "✓ Position Preservation | ✓ Settings-Change Safe | ✓ All Features"
...
int OnInit()
{
   ...
   PrintFormat("║  Lot: %.2f | Gap: %.2f%% | Settings changes safe!", effectiveInitialLotSize, InpGridGapPercent);
   PrintFormat("╚════════════════════════════════════════════════════════════════╝");
